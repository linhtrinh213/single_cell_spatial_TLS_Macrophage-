...
```{r load objects}
output_dir = ".../Output/ST/All_samples"
seurat_transformed = readRDS(".../Datasets/Spatial_transcriptomics/Seurat_obj/seurat_transformed")

myRCTD_list = readRDS(".../Output/ST/myRCTD_list") #RCTD object (individually,no DEA yet) 
TLS_maturity_score = readRDS(".../Output/ST/TLS_maturity_score.rds")
myRCTD_DEA = readRDS(".../Output/ST/myRCTD_DEA") #RCTD object (individually) 
filtered_genes_list = readRDS(".../Output/ST/filtered_genes_list") #DEA results all samples (individually, threshold = 0)
#saveRDS(TLS_score,".../Output/ST/TLS_signature_score.rds")
#saveRDS(TLS_score,".../Output/ST/TLS_maturity_score.rds")
saveRDS(merge_ST,".../Output/ST/merge_ST") 
GeneCard_MP = read.csv(".../Output/ST/GeneCards-SearchResults.csv")
...
#################### Importing samples 
data_dir = ".../Datasets/Spatial_transcriptomics/GSE175540/"
...
# Plot only 46
png(".../Output/ST/All_samples/Preprocessing/TLS_Annotation_46.png", width = 800, height = 800)
...
png(paste0(".../Output/ST/All_samples/SpatialFeaturePlot/PDCD1.png"), width = 2500, height = 2000)
all_combined_plots
dev.off()

genes = c("MRC1", "CD163", "TGM2", "STAT6","FCGR3A", "CYBB", "TLR2", "STAT1")
png(paste0(".../Output/ST/All_samples/SpatialFeaturePlot/M1M2_Boxplot.png"), width = 1500, height = 1000)
...
for (gene in genes_vector) {
  ...
  output_file <- paste0(".../Output/ST/All_samples/SpatialFeaturePlot/", gene, ".png")
...
png (".../Output/ST/All_samples/Boxplots/FCGR3A.png",width = 1500, height = 1700)
multiplot
dev.off()
...
# Print or save the combined plot
png (".../Output/ST/All_samples/Boxplots/PosvsNeg_final4.png",width = 1300, height = 1000)
multiplot
dev.off()
...
# Print or save the combined plot
png (".../Output/ST/All_samples/Boxplots/M1vsM2_final4.png",width = 1000, height = 1500)
multiplot
dev.off()
...
TLS_sig = readRDS(".../Output/ST/TLS_signature_score.rds")
...
TLS_signature_score = readRDS(".../Output/ST/TLS_signature_score.rds")
...
saveRDS(filtered_genes_list,".../Output/ST/filtered_genes_list") #DEA results all samples (individually, threshold = 0)
filtered_genes_list = readRDS (".../Output/ST/filtered_genes_list")
```
...
myRCTD = readRDS(".../Output/ST/myRCTD_combine_DEA")
...
output_dir = ".../Output/ST/All_samples/RCTD/Barplots/"
...
#top_10 <- as.data.frame(mean_df[order(-mean_df)][1:10])
  ...
  png(".../Output/ST/All_samples/RCTD/Barplots/Allsamples_Barplot/TLS_neg.png", width = 500, height = 1000)
...
png (".../Output/ST/RCTD/ccRCC_ref/DEA/Volcano.png",width = 700, height = 1000)
...
output_dir = ".../Output/ST/All_samples/RCTD/Volcano"
