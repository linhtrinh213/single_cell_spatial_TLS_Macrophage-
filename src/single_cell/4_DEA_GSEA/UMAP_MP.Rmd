...
GSE_merge_annotated = readRDS ("/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_merge_annotated")
GSE_MP = readRDS ("/omics/groups/OE0436/data/Linh/Datasets/DEA/GSE_MP")
GSE_MP_SCT = readRDS ( "/omics/groups/OE0436/internal/Linh/Datasets/GSE_MP_SCT")
GSE_MP_pos = readRDS("/omics/groups/OE0436/internal/Linh/Datasets/GSE_MP_pos")
saveRDS(all.markers,"/omics/groups/OE0436/internal/Linh/Datasets/all.markers_MPpos") # all markers for TLS+ MP (5 clusters)
```
...
#saving the plot
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_Anno.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("ct_ann_GSE344_10kSingleR")) #ct_ann_GSE344_10kSingleR
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_cancertypes.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("cancer_types")) #ct_ann_GSE344_10kSingleR
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_TLS.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("TLS_patient"))
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_datasets.png",width = 800, height = 600)
...
#saving the plot
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_Anno_DEA.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("ct_ann_GSE344_10kSingleR")) #ct_ann_GSE344_10kSingleR
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_cancertypes_DEA.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("cancer_types")) #ct_ann_GSE344_10kSingleR
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_TLS_DEA.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("TLS_patient"))
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_datasets_DEA.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("dataset_ID"))
dev.off()
png ("/omics/groups/OE0436/data/Linh/Output/DEA/UMAP_cluster_datasets.png",width = 800, height = 600)
DimPlot(GSE_MP_SCT, reduction = "umap", group.by = c("dataset_ID"))
...
png ("/omics/groups/OE0436/internal/Linh/Output/new_UMAP/UMAP_cluster0.1.png",width = 650, height = 450)
...
MP.markers_all %>%
  ...
  #  arrange(desc(avg_log2FC)) %>% 
    slice_head(n = 20) %>%
    ungroup() -> top50
png ("/omics/groups/OE0436/internal/Linh/Output/new_UMAP/Heatmap_TLSpos.png",width = 800, height = 600)
...
DimPlot(GSE_MP_pos, reduction = "umap", group.by = c("seurat_clusters")) #with 0.1 resolution: 5 clusters
png ("/omics/groups/OE0436/internal/Linh/Output/new_UMAP/TLSpos.png",width = 500, height = 400)
...
```{r}
require(DOSE)
png("/omics/groups/OE0436/internal/Linh/Output/GSEA/cluster0_CC.png", width = 500, height = 600)
dotplot(gse_0, showCategory=5, split=".sign") + facet_grid(.~.sign)
dev.off()
png("/omics/groups/OE0436/internal/Linh/Output/GSEA/cluster1_CC.png", width = 500, height = 600)
dotplot(gse_1, showCategory=5, split=".sign") + facet_grid(.~.sign)
dev.off()
png("/omics/groups/OE0436/internal/Linh/Output/GSEA/cluster2_CC.png", width = 500, height = 600)
dotplot(gse_2, showCategory=5, split=".sign") + facet_grid(.~.sign)
dev.off()
png("/omics/groups/OE0436/internal/Linh/Output/GSEA/cluster3_MF.png", width = 500, height = 600)
dotplot(gse_3, showCategory=5, split=".sign") + facet_grid(.~.sign)
dev.off()
png("/omics/groups/OE0436/internal/Linh/Output/GSEA/cluster4_MF.png", width = 550, height = 650)
