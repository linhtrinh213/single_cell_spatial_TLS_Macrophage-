...
merged_GSE186344 = readRDS ("/omics/groups/OE0436/data/Linh/Datasets/GSE186344/merged_seurat")
GSE174401_brainmet = readRDS ("/omics/groups/OE0436/data/Linh/Datasets/GSE174401/GSE174401_brainmet")
GSE234832 = readRDS ("/omics/groups/OE0436/data/Linh/Datasets/GSE234832/GSE234832")
GSE131907_seurat = readRDS("/omics/groups/OE0436/data/Linh/Datasets/GSE131907/GSE131907_seurat")
GSE131907_seurat_filtered = readRDS("/omics/groups/OE0436/data/Linh/Datasets/GSE131907/GSE131907_seurat")
GSE_all = readRDS("/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all")
GSE_all_sub = readRDS("/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all_sub") #object no scale. 4 datasets

GSE186344 = readRDS ("/omics/groups/OE0436/internal/Linh/Datasets/GSE186344") #SCTransform object 
GSE_SCT  = readRDS ( "/omics/groups/OE0436/internal/Linh/results/GSE_SCT") #SCTransform, 3 datasets
GSE_integrated  = readRDS ( "/omics/groups/OE0436/internal/Linh/results/GSE_integrated") #SCTransform, 3 datasets
...
Error: package or namespace load failed for ‘Seurat’ in dyn.load(file, DLLpath = DLLpath, ...):
 unable to load shared object '/home/k967h/R/x86_64-pc-linux-gnu-library/4.3/igraph/libs/igraph.so':
...
GSE174401 = Read10X_h5 ("/omics/groups/OE0436/data/Linh/Datasets/GSE174401/GSE174401_filtered_feature_bc_matrix.h5")
...
SaveSeuratRds(GSE174401_brainmet,"/omics/groups/OE0436/data/Linh/Datasets/GSE174401/GSE174401_brainmet") #take a bit 
...
GSE131907 <- read.table("/omics/groups/OE0436/data/Linh/Datasets/GSE131907/GSE131907_Lung_Cancer_raw_UMI_matrix.txt", sep = "\t", header = TRUE)
...
SaveSeuratRds(GSE131907_seurat_filtered,"/omics/groups/OE0436/data/Linh/Datasets/GSE131907/GSE131907_seurat_filtered") #take a bit 
...
SaveSeuratRds(GSE131907_seurat,"/omics/groups/OE0436/data/Linh/Datasets/GSE131907/GSE131907_seurat") #take a bit 
...
```{r}
folder_path = "/omics/groups/OE0436/data/Linh/Datasets/GSE234832/" #path to folder
files <- list.files(folder_path) #list all of the files in folder_path
...
SaveSeuratRds(GSE234832,"/omics/groups/OE0436/data/Linh/Datasets/GSE234832/GSE234832") #take a bit 
...
SaveSeuratRds(GSE_all,"/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all") #saved 18.04 (4 layers)
...
SaveSeuratRds(GSE_all,"/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all") #saved 22.04: with metadata
...
#saving the plot
png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/VlnPlot_GSE186344_bQC",width = 1000, height = 700)
VlnPlot(GSE_all, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3, idents = "GSE186344")
dev.off()

png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/VlnPlot_GSE174401_bQC",width = 1000, height = 700)
VlnPlot(GSE_all, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3, idents = "GSE174401")
dev.off()

png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/VlnPlot_GSE131907_bQC",width = 1000, height = 700)
VlnPlot(GSE_all, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3, idents = "GSE131907")
dev.off()

png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/VlnPlot_GSE234832_bQC",width = 1000, height = 700)
...
```{r Feature Plots}
# Feature Scatter
png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/FeaturePlot_bQC",width = 1000, height = 700)
FeatureScatter(GSE_all, feature1 = "nCount_RNA", feature2 = "percent.mt")
dev.off()

# Feature Scatter
png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/FeaturePlot_CountvsFeature_bQC",width = 1000, height = 700)
...
SaveSeuratRds(GSE_all_sub,"/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all_sub") #saved 25.04 with new parameters
...
saveRDS (GSE_all_sub, "/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_all_sub2")
```
...
saveRDS (GSE186344, "/omics/groups/OE0436/internal/Linh/Datasets/GSE186344")
...
GSE_3datasets <- merge(x =  GSE186344, y = c(GSE174401,GSE234832)) #add.cells.id so that cell barcode don't overlap accidentally
saveRDS (GSE_3datasets, "/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_3datasets")
...
saveRDS (GSE234832, "/omics/groups/OE0436/internal/Linh/Datasets/GSE234832")

GSE186344 <- SCTransform(GSE186344, return.only.var.genes = TRUE)

GSE174401 <- SCTransform(GSE174401, return.only.var.genes = TRUE)
saveRDS (GSE174401, "/omics/groups/OE0436/internal/Linh/Datasets/GSE174401")
...
png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/UMAP_afterIntegration2",width = 1000, height = 700)
DimPlot(GSE_SCT, reduction = "umap", group.by = c("dataset_ID"))
dev.off()

saveRDS (GSE_SCT, "/omics/groups/OE0436/internal/Linh/results/GSE_integrated")
...
png ("/omics/groups/OE0436/data/Linh/Output/Preprocessing/UMAP_treatment",width = 1000, height = 700)
