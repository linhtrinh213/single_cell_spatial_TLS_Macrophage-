...
```{r}
readRDS(GSE_merge,"/omics/groups/OE0436/data/Linh/Datasets/Merged/GSE_merge_annotated") #GSE 3 datasets,annotated
...
celltype = readRDS( "/omics/groups/OE0436/data/Linh/Datasets/DEA/cell_type")

saveRDS(GSE_rest2, "/omics/groups/OE0436/data/Linh/Datasets/DEA/GSE_rest2") #only samples that passed the threshold for cell numbers
saveRDS (geometric_means, "/omics/groups/OE0436/data/Linh/Datasets/DEA/TLS_score_allcells")
...
saveRDS(GSE_rest2, "/omics/groups/OE0436/data/Linh/Datasets/DEA/GSE_rest2") #only immune cells, around 25k. Saved 13.05 - run second time
...
png ("/omics/groups/OE0436/data/Linh/Output/DEA/TLS_Score_subset2.png",width = 700, height = 1000)
...
png ("/omics/groups/OE0436/data/Linh/Output/DEA/TLS_Score_2.png",width = 700, height = 1000)
ggplot(geometric_means, aes(x = "Patient_ID",y = as.numeric(score))) + geom_boxplot(fill = "transparent") + geom_point(color="blue", size= 2 , alpha=0.9) + labs(titel="TLS Signature Scores", y = "Scores")
dev.off()
